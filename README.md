...
| Section | Content |
|---|---|
| Hero | Name, animated role, description, social links, meta info |
| About | Bio, tech stack cards (Cloud, AI/LLM, DevOps) |
| Experience | Cogent IBS (Junior AI Engineer), Cogent IBS (Intern), HCL Tech / Merck |
| Projects | ApplyEdge, FoodyBuddy, QueryVault, AI Audio Analyzer |
| Skills | Proficiency bars for Cloud, AI/ML, Development |
| Certifications | 6 verified credentials (AWS, GitHub, Oracle, DevOps, Python) |
| Contact | Email, Phone, LinkedIn, GitHub, Google Calendar booking |
...
The built-in AI assistant handles 30+ intents including:

- General: greeting, about, skills, experience, education, certifications
- Project deep-dives: ApplyEdge, FoodyBuddy, QueryVault, AI Audio Analyzer
- Recruiter flow: hire me, why hire Siva, job preferences, schedule a call
- Actions: download resume (auto-opens modal), tell me more (context-aware follow-up)
- Tech-specific: AWS, AI/LLM, Python, React, DevOps, Terraform
...
```bash
git clone https://github.com/siva-rama-krishna-reddy18/My-Portfolio.git
cd My-Portfolio
open index.html
```

Or deploy to GitHub Pages, Vercel, Netlify, or any static host.
...
- **Email:** srkreddykunchala@gmail.com
- **LinkedIn:** [siva-rama-krishna-reddy-kunchala](https://www.linkedin.com/in/siva-rama-krishna-reddy-kunchala-9a35371b7/)
- **GitHub:** [siva-rama-krishna-reddy18](https://github.com/siva-rama-krishna-reddy18)
- **Schedule a Call:** [Google Calendar](https://calendar.app.google/Uyi1f2gMhwVBcuby6)

---

© Siva Rama Krishna Reddy Kunchala — Fort Lauderdale, FL
